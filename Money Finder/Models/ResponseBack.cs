...
namespace Money_Finder.Models
{
    public class ResponseBack
    {
        ...
        public class ResponseBackk<T>
        {
            private int status_value = 0;
            private string message_value = "";
            private T data_value = default(T);
            private T dataa_value = default(T);
            private T dataac_value = default(T);
            ...
            public T advertisers
            {
                get { return data_value; }
                set { data_value = value; }
             
        }
            public T everflowoffers
            {
                get { return dataa_value; }
                set { dataa_value = value; }
            }
            public T account_executive
            {
                get { return dataac_value; }
                set { dataac_value = value; }
            }
        }
    }
}
