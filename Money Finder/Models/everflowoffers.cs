...
{
    public class everflowoffers
    {
       [Key]
        public int networkid { get; set; }
        //[Display(Name = "network_offer_id")]
    ...
    public class Relationships
    {
        ...
        public PayoutRevenue payout_revenue { get; set; }
        ...
        public RequirementKpis requirement_kpis { get; set; }
        public RequirementTrackingParameters requirement_tracking_parameters { get; set; }
    }

    public class RequirementKpis
    {
        [Key]
        public int networkid { get; set; }
        public int total { get; set; }
    ...
    public class RequirementTrackingParameters
    {
        [Key]
        public int networkid { get; set; }
        public int total { get; set; }
