...
! function(e, t) {
    ...
    l.prototype = {
        ...
        asyncIsValid: function() {
            return a.warnOnce("asyncIsValid is deprecated; please use whenIsValid instead"), this.whenValid.apply(this, arguments)
        },
    ...
    y.prototype = {
        ...
        setupForm: function(t) {
            t.$element.on("submit.Parsley", !1, e.proxy(t.onSubmitValidate, t)), t.$element.on("click.Parsley", 'input[type="submit"], button[type="submit"]', e.proxy(t.onSubmitButton, t)), !1 !== t.options.uiEnabled && t.$element.attr("novalidate", "")
        },
    ...
    g.prototype = {
        onSubmitValidate: function(e) {
            var t = this;
            if (!0 !== e.parsley) return this._$submitSource = this._$submitSource || this.$element.find('input[type="submit"], button[type="submit"]').first(), this._$submitSource.is("[formnovalidate]") ? void(this._$submitSource = null) : (e.stopImmediatePropagation(), e.preventDefault(), this.whenValidate(void 0, void 0, e).done(function() {
                t._submit()
            }).always(function() {
        ...
        _submit: function() {
            !1 !== this._trigger("submit") && (this.$element.find(".parsley_synthetic_submit_button").remove(), this._$submitSource && e('<input class="parsley_synthetic_submit_button" type="hidden">').attr("name", this._$submitSource.attr("name")).attr("value", this._$submitSource.attr("value")).appendTo(this.$element), this.$element.trigger(e.extend(e.Event("submit"), {
                parsley: !0
            })))
        },
        validate: function(e, t, i) {
            return v[this.whenValidate(e, t, i).state()]
        },
        whenValidate: function(t, i, n) {
            var r = this;
            this.submitEvent = n, this.validationResult = !0, this._trigger("validate"), this._refreshFields();
            var s = this._withoutReactualizingFormOptions(function() {
                    return e.map(this.fields, function(e) {
                        return !t || r._isFieldInGroup(e, t) ? e.whenValidate(i) : void 0
                    })
                }),
                a = function() {
                    var t = e.Deferred();
                    return !1 === r.validationResult && t.reject(), t.resolve().promise()
                };
            return e.when.apply(e, s).done(function() {
                r._trigger("success")
            }).fail(function() {
                r.validationResult = !1, r._trigger("error")
            }).always(function() {
                r._trigger("validated")
            }).pipe(a, a)
        },
        isValid: function(e, t) {
            return v[this.whenValid(e, t).state()]
        },
        whenValid: function(t, i) {
            ...
            var r = this._withoutReactualizingFormOptions(function() {
                return e.map(this.fields, function(e) {
                    return !t || n._isFieldInGroup(e, t) ? e.whenValid(i) : void 0
                })
            });
            return e.when.apply(e, r)
        },
        _isFieldInGroup: function(t, i) {
            return e.isArray(t.options.group) ? -1 !== e.inArray(i, t.options.group) : t.options.group === i
        },
        ...
        _bindFields: function() {
            ...
            return this.fields = [], this.fieldsMappedById = {}, this._withoutReactualizingFormOptions(function() {
                this.$element.find(this.options.inputs).not(this.options.excluded).each(function() {
                    var e = new window.Parsley.Factory(this, {}, t);
                    "ParsleyField" !== e.__class__ && "ParsleyFieldMultiple" !== e.__class__ || !0 === e.options.excluded || "undefined" == typeof t.fieldsMappedById[e.__class__ + "-" + e.__id__] && (t.fieldsMappedById[e.__class__ + "-" + e.__id__] = e, t.fields.push(e))
                }), e(i).not(t.fields).each(function() {
                    this._trigger("reset")
                })
            }), this
        },
    ...
    F.prototype = {
        ...
        whenValidate: function(e) {
            var t = this;
            return this.value = this.getValue(), this._trigger("validate"), this.whenValid(e, this.value).done(function() {
                t._trigger("success")
            }).fail(function() {
                t._trigger("error")
            }).always(function() {
        ...
        isValid: function(e, t) {
            return b[this.whenValid(e, t).state()]
        },
        whenValid: function(t, i) {
            if (this.refreshConstraints(), this.validationResult = !0, !this.hasConstraints()) return e.when();
            if ("boolean" != typeof t && "undefined" == typeof i && (i = t, t = !1), ("undefined" == typeof i || null === i) && (i = this.getValue()), !this.needsValidation(i) && !0 !== t) return e.when();
            var n = this._getGroupedConstraints(),
                r = [],
                s = this;
            return e.each(n, function(t, n) {
                var a = e.when.apply(e, e.map(n, e.proxy(s, "_validateConstraint", i)));
                return r.push(a), "rejected" === a.state() ? !1 : void 0
            }), e.when.apply(e, r)
        },
    ...
    x.prototype = {
        ...
        handleMultiple: function() {
            ...
            this.options.multiple = this.options.multiple.replace(/(:|\.|\[|\]|\{|\}|\$)/g, ""), "undefined" != typeof t && e('input[name="' + t + '"]').each(function() {
                e(this).is("input[type=radio], input[type=checkbox]") && e(this).attr(n.options.namespace + "multiple", n.options.multiple)
            });
            for (var r = this._findRelatedMultiple(), s = 0; s < r.length; s++)
        ...
        bind: function(t, i) {
            ...
            switch (t) {
                case "parsleyForm":
                    n = e.extend(new g(this.$element, this.domOptions, this.options), window.ParsleyExtend)._bindFields();
                    break;
                case "parsleyField":
                    n = e.extend(new $(this.$element, this.domOptions, this.options, this.parent), window.ParsleyExtend);
                    break;
                case "parsleyFieldMultiple":
                    n = e.extend(new $(this.$element, this.domOptions, this.options, this.parent), new C, window.ParsleyExtend)._init();
                    break;
                default:
    ...
    P.forEach || a.warn("Parsley requires ES5 to run properly. Please include https://github.com/es-shims/es5-shim");
    var V = e.extend(new l, {
        $element: e(document),
    ...
    e.extend($.prototype, l.prototype), e.extend(g.prototype, l.prototype), e.extend(x.prototype, l.prototype), e.fn.parsley = e.fn.psly = function(t) {
            if (this.length > 1) {
                var i = [];
        ...
        }, "undefined" == typeof window.ParsleyExtend && (window.ParsleyExtend = {}), V.options = e.extend(a.objectCreate(o), window.ParsleyConfig), window.ParsleyConfig = V.options,
        window.Parsley = window.psly = V, window.ParsleyUtils = a;
    ...
    window.ParsleyValidator = {}, e.each("setLocale addCatalog addMessage addMessages getErrorMessage formatMessage addValidator updateValidator removeValidator".split(" "), function(t, i) {
        window.Parsley[i] = e.proxy(E, i), window.ParsleyValidator[i] = function() {
            return a.warnOnce("Accessing the method '" + i + "' through ParsleyValidator is deprecated. Simply call 'window.Parsley." + i + "(...)'"), window.Parsley[i].apply(window.Parsley, arguments)
        }
    ...
    e.listen = function(e, n) {
        ...
        if (R(), !(e instanceof $ || e instanceof g)) throw new Error("Must give Parsley instance");
        ...
        R();
        var n = t instanceof $ || t instanceof g,
            r = Array.prototype.slice.call(arguments, n ? 2 : 1);
        r.unshift(i(e)), n || (t = window.Parsley), t.trigger.apply(t, r)
    };
    e.extend(!0, V, {
        asyncValidators: {
            "default": {
        ...
        eventValidate: function(e) {
            new RegExp("key").test(e.type) && !this._ui.validationInformationVisible && this.getValue().length <= this.options.validationThreshold || (this._ui.validatedOnce = !0, this.whenValidate())
        }
    }), V.addValidator("remote", {
        requirementType: {
            "": "string",
            validator: "string",
            reverse: "boolean",
        ...
        validateString: function(t, i, n, r) {
            ...
            if ("undefined" == typeof V.asyncValidators[l]) throw new Error("Calling an undefined async validator: `" + l + "`");
            i = V.asyncValidators[l].url || i, i.indexOf("{value}") > -1 ? i = i.replace("{value}", encodeURIComponent(t)) : o[r.$element.attr("name") || r.$element.attr("id")] = t;
            var u = e.extend(!0, n.options || {}, V.asyncValidators[l].options);
            s = e.extend(!0, {}, {
                url: i,
                data: o,
                type: "GET"
            }, u), r.trigger("field:ajaxoptions", r, s), a = e.param(s), "undefined" == typeof V._remoteCache && (V._remoteCache = {});
            var d = V._remoteCache[a] = V._remoteCache[a] || e.ajax(s),
                h = function() {
                    var t = V.asyncValidators[l].fn.call(r, d, i, n);
                    return t || (t = e.Deferred().reject()), e.when(t)
                };
            return d.then(h, h)
        },
        priority: -1
    }), V.on("form:submit", function() {
        V._remoteCache = {}
    }), window.ParsleyExtend.addAsyncValidator = function() {
        return ParsleyUtils.warnOnce("Accessing the method `addAsyncValidator` through an instance is deprecated. Simply call `Parsley.addAsyncValidator(...)`"), V.apply(V.addAsyncValidator, arguments)
    }, V.addMessages("en", {
        ...
        pattern: "This value contains invalid character(s).",
